...
ggplot(data=subset(mod_vars,Depth==0.1),
  ...
  theme(panel.grid.major = element_blank(), 
        ...
        panel.background = element_rect(
          fill = "white"))
#ggsave("figures/mod_vars_scenario_scatterplot_0.1m.jpg", width=7, height=4) 

ggplot(data=subset(mod_vars,Depth==9),
       aes(x = year, y = yearly_mean, color = scenario)) +
  geom_point(size=2) + 
  facet_wrap(~var, scales="free_y") +
  xlab("")+
  ...
  theme(panel.grid.major = element_blank(), 
        ...
        panel.background = element_rect(
          fill = "white"))
#ggsave("figures/mod_vars_scenario_scatterplot_9m.jpg", width=7, height=4) 
